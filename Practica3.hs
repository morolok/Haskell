...
-- En esta relacion se presentan ejercicios con definiciones de
-- funciones por comprension. Estos ejercicios se corresponden con el
-- tema 4 
...
-- primeros n numeros; es decir, 1^2 + 2^2 + ... + 100^2. Por ejemplo,
--    sumaDeCuadrados 3    ==  14
--    sumaDeCuadrados 100  ==  338350
-- ---------------------------------------------------------------------

sumaDeCuadrados n = sum([x*x | x <- [1..n]])

-- ---------------------------------------------------------------------
-- Ejercicio 2. Un entero positivo es perfecto si es igual a la suma de
-- sus factores, excluyendo el propio numero. Usando una lista por
-- comprension y la funcion factores (del tema), definir la funcion 
--    perfectos :: Int -> [Int]
...
-- La funcion factores del tema es
factores :: Int -> [Int]
...
-- correspondientes. Definir por comprension la funcion 
...
-- La definicion es
productoEscalar :: [Int] -> [Int] -> Int
productoEscalar xs ys = sum([(fst xys)*(snd xys) | xys <- (zip xs ys)])
...
--quickCheck prop_conmutativa_productoEscalar

-- ---------------------------------------------------------------------
-- Ejercicio 4 (Problema 1 del proyecto Euler) Definir la funcion
--    euler1 :: Integer -> Integer
-- (euler1 n) es la suma de todos los multiplos de 3 o 5 menores que
-- n. Por ejemplo,
--    euler1 10  ==  23
-- 
...
-- ---------------------------------------------------------------------
-- Ejercicio 5. Definir por comprension la funcion
--    replica :: Int -> a -> [a]
-- tal que (replica n x) es la lista formada por n copias del elemento
-- x. Por ejemplo,
--    *Main> replica 3 True
--    [True, True, True]
-- Se corresponde con la funcion replicate.
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 6. Un numero natural n se denomina abundante si es menor
-- que la suma de sus divisores propios. Por ejemplo, 12 y 30 son
-- abundantes pero 5 y 28 no lo son.
-- ---------------------------------------------------------------------
-- Ejercicio 6.1. Definir la funcion numeroAbundante tal que
-- (numeroAbundante n) se verifica si n es un numero abundante. Por
-- ejemplo, 
...
numeroAbundante n = sum([x | x <- [1..n-1], mod n x == 0]) > n

-- ---------------------------------------------------------------------
-- Ejercicio 6.2. Definir la funcion numerosAbundantesMenores tal que
-- (numerosAbundantesMenores n) es la lista de numeros abundantes
...
-- ---------------------------------------------------------------------
-- Ejercicio 6.3. Definir la funcion todosPares tal que (todosPares n)
-- se verifica si todos los numeros abundantes menores o iguales que n
...
todosPares n = (length [x | x <- numerosAbundantesMenores n, even x]) == (length (numerosAbundantesMenores n))

-- ---------------------------------------------------------------------
-- Ejercicio 6.4. Definir la constante primerAbundanteImpar que calcule
-- el primer numero natural abundante impar. Determinar el valor de
-- dicho numero.
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 7. Definir la funcion suma tal (suma n) es la suma de los
-- n primeros numeros. Por ejemplo,
--    suma 3  ==  6
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 8. Los triangulo aritmetico se forman como sigue
--     1                                 1
--     2  3                              2
--     4  5  6                           3
--     7  8  9 10                        4
--    11 12 13 14 15                     5
--    16 17 18 19 20 21                  6
-- Definir la funcion linea tal que (linea n) es la linea n-esima de los
-- triangulos aritmeticos. Por ejemplo, 
--    linea 4  ==  [7,8,9,10]
...
-- ---------------------------------------------------------------------
-- Ejercicio 9. Definir la funcion triangulo tal que (triangulo n) es
-- el triangulo aritmetico de altura n. Por ejemplo,
...
-- ---------------------------------------------------------------------
-- Ejercicio 10. Definir la funcion circulo tal que (circulo n) es la
-- cantidad de pares de numeros naturales (x,y) que se encuentran dentro
-- del circulo de radio n. Por ejemplo, 
--    circulo 3  ==  9
--    circulo 4  ==  15
--    circulo 5  ==  22
-- La ecuacion de los puntos que estan en la circunferencia de centro (0,0)
...
-- ---------------------------------------------------------------------
-- Ejercicio 11. Definir la funcion ocurrenciasDelMaximo tal que
-- (ocurrenciasDelMaximo xs) es el par formado por el mayor de los
-- numeros de xs y el numero de veces que este aparece en la lista
-- xs, si la lista es no vacia y es (0,0) si xs es la lista vacia. Por
-- ejemplo,  
...
ocurrenciasDelMaximo xs = (maximo, length [1 | x <- xs, x == maximo])
                     where maximo = maximum xs

-- ---------------------------------------------------------------------
-- Ejercicio 12. Definir, por comprension, la funcion tienenS tal que
-- (tienenS xss) es la lista de las longitudes de las cadenas de xss que
-- contienen el caracter 's' en mayusculas o minusculas. Por ejemplo, 
...
-- ---------------------------------------------------------------------
-- Ejercicio 13. Decimos que una lista esta algo ordenada si para todo
-- par de elementos consecutivos se cumple que el primero es menor o
-- igual que el doble del segundo. Definir, por comprension, la funcion
-- (algoOrdenada xs) que se verifica si la lista xs esta algo ordenada. 
-- Por ejemplo, 
...
-- ---------------------------------------------------------------------
-- Ejercicio 14. Definir, por comprension, la funcion tripletas tal 
...
tripletas xs = [take 3 (drop n xs) | n <- [0..length xs-3]]

-- ---------------------------------------------------------------------
-- Ejercicio 15. Definir la funcion tresConsecutivas tal que
...
-- ---------------------------------------------------------------------
-- Ejercicio 16.1. Definir la funcion unitarios tal (unitarios n) es
-- la lista de numeros [n,nn, nnn, ....]. Por ejemplo. 
...
-- ---------------------------------------------------------------------
-- Ejercicio 16.2. Definir la funcion multiplosUnitarios tal que
-- (multiplosUnitarios x y n) es la lista de los n primeros multiplos de
-- x cuyo unico digito es y. Por ejemplo,
...
-- ---------------------------------------------------------------------
-- Ejercicio 17. Definir la funcion primosEntre tal que (primosEntre x y)
-- es la lista de los numero primos entre x e y (ambos inclusive). Por
-- ejemplo, 
...
primosEntre x y = if (x < y) then [z | z <- [x..y], (mod ((factorial (z-1)) + 1) z) == 0] else error "El primer numero debe ser menor que el segundo"

primosEntre2 x y = [z | z <- [x..y], (mod (num z) z) == 0]
            where num z = (factorial (z-1)) + 1

-- ---------------------------------------------------------------------
-- Ejercicio 18. Definir la funcion cortas tal que (cortas xs) es la
-- lista de las palabras mas cortas (es decir, de menor longitud) de la
...
-- divisible por ningun m^2 > 1. Por ejemplo, 10 es libre de cuadrado
-- (porque 10 = 2*5) y 12 no lo es (ya que es divisible por 2^2). 
-- Definir la funcion libresDeCuadrado tal que (libresDeCuadrado n) es
-- la lista de los primeros n numeros libres de cuadrado. Por ejemplo,
...
-- ---------------------------------------------------------------------
-- Ejercicio 20. Definir la funcion masOcurrentes tal que
-- (masOcurrentes xs) es la lista de los elementos de xs que ocurren el
-- maximo numero de veces. Por ejemplo,
...
-- ---------------------------------------------------------------------
-- Ejercicio 21.1. Definir la funcion numDiv tal que (numDiv x) es el
-- numero de divisores del numero natural x. Por ejemplo, 
--    numDiv 11 == 2 
--    numDiv 12 == 6 
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 21.2. Definir la funcion entre tal que (entre a b c) es la
...
-- ---------------------------------------------------------------------
-- Ejercicio 22. Definir la funcion conPos tal que (conPos xs) es la
...
-- ---------------------------------------------------------------------
-- Ejercicio 23. Definir la funcion tal que (pares cs) es la cadena
-- formada por los caracteres en posicion par de cs. Por ejemplo, 
...
-- ---------------------------------------------------------------------
-- Ejercicio 24.1. Una terna (x,y,z) de enteros positivos es pitagorica
-- si x^2 + y^2 = z^2. Usando una lista por comprension, definir la
-- funcion 
--    pitagoricas :: Int -> [(Int,Int,Int)]
-- tal que (pitagoricas n) es la lista de todas las ternas pitagoricas
-- cuyas componentes estan entre 1 y n. Por ejemplo, 
...
-- ---------------------------------------------------------------------
-- Ejercicio 24.2. Definir la funcion 
--    numeroDePares :: (Int,Int,Int) -> Int
-- tal que (numeroDePares t) es el numero de elementos pares de la terna
-- t. Por ejemplo,
...
-- ---------------------------------------------------------------------
-- Ejercicio 24.3. Definir la funcion
--    conjetura :: Int -> Bool
-- tal que (conjetura n) se verifica si todas las ternas pitagoricas
-- cuyas componentes estan entre 1 y n tiene un numero impar de numeros
-- pares. Por ejemplo,
--    conjetura 10  ==  True
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 25. Definir, por comprension, la funcion
...
-- forma densa. 
-- representacion dispersa es xs. Por ejemplo, 
...
-- 
-- Definir, usando dos listas por comprension con un generador cada una,
-- la funcion 
--    pares2' :: [a] -> [b] -> [(a,b)]
-- tal que pares2' sea equivalente a pares2.
-- 
-- Indicacion: Utilizar la funcion predefinida concat y encajar una
-- lista por comprension dentro de la otra. 
-- ---------------------------------------------------------------------

-- La definicion de pares es
pares2 :: [a] -> [b] -> [(a,b)]
pares2 xs ys = [(x,y) | x <- xs, y <- ys]

-- La redefinicion de pares es
pares2' :: [a] -> [b] -> [(a,b)]
...
-- ---------------------------------------------------------------------
-- Ejercicio 28.1. Definir la funcion nombres tal que (nombres bd) es
...
-- ---------------------------------------------------------------------
-- Ejercicio 28.2. Definir la funcion musicos tal que (musicos bd) es
-- la lista de los nombres de los musicos de la base de datos bd. Por
-- ejemplo,  
...
-- ---------------------------------------------------------------------
-- Ejercicio 28.3. Definir la funcion seleccion tal que (seleccion bd m) 
...
-- ---------------------------------------------------------------------
-- Ejercicio 28.4. Definir, usando el apartado anterior, la funcion
-- musicos' tal que (musicos' bd) es la lista de los nombres de los
-- musicos de la base de datos bd. Por ejemplo,  
--    ghci> musicos' personas
--    ["Beethoven","Mozart","Bach"]
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 28.5. Definir la funcion vivas tal que (vivas bd a) es la
-- lista de los nombres de las personas de la base de datos bd  que
-- estaban vivas en el anyo a. Por ejemplo,  
--    ghci> vivas personas 1600
--    ["Cervantes","Velazquez","Quevedo","Borromini"]
-- ---------------------------------------------------------------------

vivas :: [(String,String,Int,Int)] -> Int -> [String]
vivas ps a = [a | (a, _, c, d) <- ps, c < 1600 && d > 1600]

-- ---------------------------------------------------------------------
-- Ejercicio 29.1. En este ejercicio se consideran listas de ternas de
-- la forma (nombre, edad, poblacion). 
-- 
-- Definir la funcion puedenVotar tal que (puedenVotar t) es la
-- lista de las personas de t que tienen edad para votar. Por ejemplo,
--    ghci> puedenVotar personas2
--    ["Juan","Alba","Pedro"]
-- ---------------------------------------------------------------------

personas2 = [("Ana", 16, "Sevilla"), ("Juan", 21, "Coria"), ("Alba", 19, "Camas"), ("Pedro",18,"Sevilla")]

puedenVotar t = [nombre | (nombre, edad, _) <- t, edad >= 18]

-- ---------------------------------------------------------------------
-- Ejercicio 29.2. Definir la funcion puedenVotarEn tal que (puedenVotar
-- t p) es la lista de las personas de t que pueden votar en la
-- poblacion p. Por ejemplo, 
--    ghci> puedenVotarEn personas2 "Sevilla"
--    ["Pedro"]
-- ---------------------------------------------------------------------

puedenVotarEn t c = [nombre | (nombre, edad, poblacion) <- t, edad >= 18 && poblacion == c]
...
-- 
-- Definir la funcion perpendiculares tal que (perpendiculares xs yss)
...
-- ---------------------------------------------------------------------
-- Ejercicio 31.1. Un numero natural n
...
-- ---------------------------------------------------------------------
-- Ejercicio 31.2. Definir la funcion 
--    sumaEspeciales :: Integer -> Integer
-- tal que (sumaEspeciales n) es la suma de los numeros especiales
-- menores o iguales que n. Por ejemplo, 
...
-- ---------------------------------------------------------------------
-- Ejercicio 32.1. Un numero es muy compuesto si tiene mas divisores que
-- sus anteriores. Por ejemplo, 12 es muy compuesto porque tiene 6
-- divisores (1, 2, 3, 4, 6, 12) y todos los numeros del 1 al 11 tienen
-- menos de 6 divisores.  
-- 
-- Definir la funcion
--    esMuyCompuesto :: Int -> Bool
-- tal que (esMuyCompuesto x) se verifica si x es un numero muy
-- compuesto. Por ejemplo,
--    esMuyCompuesto 24  ==  True
--    esMuyCompuesto 25  ==  False
-- Calcular  el menor numero muy compuesto de 4 cifras.
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 32.2. Definir la funcion
--    muyCompuesto :: Int -> Int
-- tal que (muyCompuesto n) es el n-esimo numero muy compuesto. Por
-- ejemplo, 
--    muyCompuesto 10  ==  180
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Ejercicio 33. Definir la funcion  
...
-- ---------------------------------------------------------------------
-- Ejercicio 34.2. Definir la funcion 
--    totalMateria :: [(String,String,Int)] -> String -> Int
-- tal que (totalMateria bd m) es el numero de alumnos de la base de
...
-- ---------------------------------------------------------------------
-- Ejercicio 35. Dada una lista de numeros enteros, definiremos el
-- mayor salto como el mayor valor de las diferencias (en valor
-- absoluto) entre numeros consecutivos de la lista. Por ejemplo, dada
-- la lista [2,5,-3] las distancias son 
--    3 (valor absoluto de la resta 2 - 5) y
--    8 (valor absoluto de la resta de 5 y (-3))
-- Por tanto, su mayor salto es 8. No esta definido el mayor salto para
